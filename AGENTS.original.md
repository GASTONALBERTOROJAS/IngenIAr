...
- Always-on: activation rules in `CLAUDE.md` (Claude Code / OpenCode) and hooks (Claude Code only)
- Sub-skills installed in `.opencode/skills/` and `.claude/skills/`: caveman, caveman-commit, caveman-review, caveman-help, compress
